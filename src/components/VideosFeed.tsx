...
const VideosFeed = () => {
  ...
  if (error) {
    return <div className="text-red-500 p-4 bg-navy-900/50 rounded-lg">Error loading YouTube videos. Please try again later.</div>;
  }

  return (
    <div className="space-y-6">
      <h2 className="text-xl font-bold text-white mb-4">Latest Esports Videos</h2>
